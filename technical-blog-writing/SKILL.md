...
When writing tutorials, explicitly look for steps where a screenshot or short screen recording would help (e.g. complex UI forms, configuration screens, multi-step CLI output) and suggest where the author should capture them.
